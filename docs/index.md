...
想用 ChatGPT、Claude、Cursor、Claude Code 等 AI 工具查詢 FinMind 的資料集和 API？我們提供 **llms.txt、Agent Skill、MCP** 三種串接方式，讓 AI 用自然語言查詢 75+ 種資料集。詳見 [AI Agent / MCP / llms.txt](tutor/ai/Llms.md)。
