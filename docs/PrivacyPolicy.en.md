...
This document governs your use of the FinMind service and consists of two parts: the Terms of Use and the Privacy Policy. By using the service, you are deemed to have read, understood, and agreed to the entire contents of this document.

## Part I — Terms of Use {#terms}

### 1. For Reference Only

All content provided is for educational and reference purposes only. Users are solely responsible for any trading losses incurred from using this data, and we assume no liability for errors, delayed updates, or transmission interruptions in the data.

For the software license, please refer to the [LICENSE](https://github.com/linsamtw/FinMind/blob/master/LICENSE).

### 2. Modification of Service

We reserve the right to temporarily or permanently modify or discontinue the service (or any part of it) at any time, with or without notice, and may terminate your access to part or all of the service at any time without prior written notice. You agree that we shall not be liable to you or any third party for any modification, suspension, or discontinuation of the service.
...
- To respond to your query and return the corresponding financial data
...
If you have any questions about this document, please email [finmind.tw@gmail.com](mailto:finmind.tw@gmail.com).
